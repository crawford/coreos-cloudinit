...
type stanzaAllowHotplug struct{}
...
func parseInterfaceStanza(attributes []string, options []string) (stanza, error) {
	...
	// TODO
	//return parseMACVLANStanza(iface, conf, attributes, optionMap)
	...
	// TODO
	//return parseBridgeStanza(iface, conf, attributes, optionMap)
...
func parseBridgeStanza(iface string, conf configMethod, attributes []string, options map[string][]string) (*stanzaInterface, error) {
	return nil, nil
}
...
func parseMACVLANStanza(iface string, conf configMethod, attributes []string, options map[string][]string) (*stanzaInterface, error) {
	return nil, nil
}
